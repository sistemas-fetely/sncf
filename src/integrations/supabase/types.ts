...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      analises_credito: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ["pedido_id"]
            isOneToOne: false
            referencedRelation: "vw_aguardando_estoque_triagem"
      ...
      contagem_estoque: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "contagem_estoque_condicao_fkey"
            columns: ["condicao"]
            isOneToOne: false
    ...
    Views: {
      ...
      vw_xpm_cad_item: {
        Row: {
          ...
          qtd_caixas_inner: number | null
          qtd_caixas_master: number | null
    ...
    Functions: {
      ...
      expirar_portoes_vencidos: { Args: never; Returns: Json }
      ...
      fn_importar_fatura_frete: {
        Args: { p_payload: Json; p_transportadora_id: string }
        Returns: Json
      }
