...
const ALL_PAGES: PageItem[] = [
  ...
  { rota: "/compras/mercadoria", titulo: "Compras de Mercadoria", pilar: "sncf", icon: Receipt, tags: ["compras", "mercadoria", "importação", "importacao", "pedido de compra", "de-para", "fornecedor"] },
