// Painel "Time" — aba padrão da Mesa do Gestor (/tarefas/mesa-gestor).
...
export default function PainelTime({ onDeclarar }: { onDeclarar: () => void }) {
      ...
      {!carregando && !erro && linhasTime.length === 0 && (
        <Card>
          ...
          <CardContent className="space-y-3">
            ...
            <p className="text-sm text-muted-foreground">
              A declaração acontece aqui mesmo, na aba <strong>Atribuições</strong> desta tela — é lá
              que cada trabalho ganha responsável, tempo por unidade e volume por dia.
            </p>
            <Button size="sm" onClick={onDeclarar}>
              Ir para a aba Atribuições
