// PainelCarga — terceira aba da Mesa do Gestor (/tarefas/mesa-gestor?aba=carga).
// Conteúdo extraído de /tarefas/carga (F4); sem PageShell/PageHeader porque a
// Mesa já fornece o envoltório.
...
export default function PainelCarga() {
