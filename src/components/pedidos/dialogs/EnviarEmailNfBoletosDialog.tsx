...
export function EnviarEmailNfBoletosDialog({ open, onOpenChange, pedido_id, parceiro_id }: Props) {
  const enviar = useEnviarEmailNfBoletos();
      ...
      <DialogContent>
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            ...
            Enviar NF + boletos por e-mail
          </DialogTitle>
          <DialogDescription>
            Confirme o(s) destinatário(s). Serão anexados a NF (PDF), o XML e os PDFs de todos os boletos.
          </DialogDescription>
        </DialogHeader>
