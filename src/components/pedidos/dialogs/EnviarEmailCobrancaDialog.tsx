...
export function EnviarEmailCobrancaDialog({ open, onOpenChange, pedido_id, parceiro_id }: Props) {
    ...
    <Dialog open={open} onOpenChange={(v) => { if (!enviar.isPending) onOpenChange(v); }}>
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Confirme o email do destinatário antes de enviar. O PDF do pedido será anexado.
          </DialogDescription>
        </DialogHeader>
