...
const PRAZO_META: Record<EixoPrazo, { label: string; ordem: number; classe: string | null }> = {
...
const PROVAS: EixoProva[] = ["registrado", "compensado", "conciliado", "devolvido", "cancelado"];
const PRAZOS: EixoPrazo[] = ["a_vencer", "vence_hoje", "vencido"];
const PROVA_FORA_KPI: EixoProva[] = ["devolvido", "cancelado"];
