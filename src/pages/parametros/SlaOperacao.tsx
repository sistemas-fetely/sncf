  ...
  return (
    <PageShell variant="dados">
      <header className="space-y-1">
        <h1 className="text-2xl font-medium tracking-tight">SLA da Operação</h1>
        <p className="text-sm text-muted-foreground">
          Prazos e limiares da operação, por área. Cada bloco tem um dono e uma unidade diferente —
          leia o aviso do bloco antes de alterar.
        </p>
      </header>
