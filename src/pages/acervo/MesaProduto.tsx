...
export default function MesaProduto() {
  ...
  const carregando=lista.isLoading||conc.isLoading||sugestoes.isLoading||fasesDim.isLoading; const erro=lista.error??conc.error??sugestoes.error??fasesDim.error;
