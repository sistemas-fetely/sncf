...
export default function MesaProduto() {
  ...
  const fixa=(key:string,cab=false)=>key==="cod_cadastro"?cn("sticky left-0 min-w-28 bg-muted",cab?"z-50":"z-20"):key==="sku"?cn("sticky left-28 min-w-32 border-r bg-muted",cab?"z-50":"z-20"):"";
