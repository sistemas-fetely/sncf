...
export default function MesaProduto() {
  ...
  const carregando=lista.isLoading||conc.isLoading||sugestoes.isLoading||fasesDim.isLoading||impactosDim.isLoading||regrasDim.isLoading||anunciosSemProduto.isLoading; const erro=lista.error??conc.error??sugestoes.error??fasesDim.error??impactosDim.error??regrasDim.error??anunciosSemProduto.error;
