  ...
  return useQuery({
    ...
    queryFn: async (): Promise<PedidoEmbalagem | null> => {
      const { data, error } = await supabase
        ...
        .select(
          "caixas_estimadas, caixas_min, caixas_max, caixas_fonte, caixas_modelo, caixas_piso_fisico, pacotes_v, pacotes_g, pacotes_p, pacotes_l, pacotes_total, litros_solidos, fator_embalagem, cubagem_expedicao_m3, peso_expedido_kg, peso_taxado_previsto, skus_sem_dimensao",
        )
