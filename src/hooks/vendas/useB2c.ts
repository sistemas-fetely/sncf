...
export interface PedidoB2cRow {
  ...
  // LASTRO-FISICO-NA-VIEW (22/09/2026): a escada de estágio foi refundada —
  // agora vem do registro do pedido, não do flag de fulfillment do Shopify.
