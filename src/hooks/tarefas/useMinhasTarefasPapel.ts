...
const CAMPOS =
  "id,titulo,descricao,status,prioridade,projeto_id,secao_id,parent_id,responsavel_id,data_inicio,data_limite,hora_limite,data_conclusao,estimativa_horas,acao_url,motivo_cancelamento,natureza,na_lista_de_trabalho,conta_carga,ordem,criado_em,papeis,trabalho_independente,mae_titulo,mae_id,eh_container,filhas_total,filhas_concluidas" as const;
