/**
 * Mapa oficial de códigos de Natureza Jurídica da Receita Federal.
 * Lista publicada pelo IBGE/Concla. Atualizada em 2024.
 */
export const NATUREZA_JURIDICA: Record<string, string> = {
  ...
  "1236": "Município",
  "1244": "Fundação Pública de Direito Privado Federal",
  "1252": "Fundação Pública de Direito Privado Estadual ou do Distrito Federal",
  "1260": "Fundação Pública de Direito Privado Municipal",
  "1279": "Comunidade Indígena",
  "1287": "Fundo Privado",
  "1295": "Fundo Público da Administração Indireta Federal",
  "1309": "Fundo Público da Administração Indireta Estadual ou do Distrito Federal",
  "1317": "Fundo Público da Administração Indireta Municipal",
  "1325": "Fundo Público da Administração Direta Federal",
  "1333": "Fundo Público da Administração Direta Estadual ou do Distrito Federal",
  "1341": "Fundo Público da Administração Direta Municipal",
  "1350": "União",
  ...
  "3131": "Entidade de Mediação e Arbitragem",
  ...
  // 5xxx — Organizações Internacionais e Outras Instituições Extraterritoriais
...
/**
 * Retorna a descrição da natureza jurídica pelo código.
 * Se não encontrar, retorna o próprio código como string.
 */
export function descricaoNaturezaJuridica(codigo: string | number | null | undefined): string {
  if (codigo == null) return "";
  const key = String(codigo);
  return NATUREZA_JURIDICA[key] || key;
}
