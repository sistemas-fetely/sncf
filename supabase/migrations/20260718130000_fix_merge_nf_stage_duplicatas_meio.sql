-- 🔵 SNCF
-- FIX merge_nf_stage: gravar duplicatas + meio_pagamento
-- Diagnóstico 18/07: parser extrai <cobr>/<dup> e tPag, payload envia,
-- mas a RPC descartava ambos (0 de 64 NFs com duplicatas no banco).
-- Mudanças marcadas com -- FIX. Todo o resto idêntico ao corpo vivo.
